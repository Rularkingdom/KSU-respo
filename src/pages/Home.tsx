...
import { ShoppingBag, ArrowRight, Leaf, Shield, Factory, Award, Truck, Users, Package, Store, Utensils, Star, ArrowUpRight } from 'lucide-react';
  ...
  return (
    <>
        ...
        <div className="container-max container-px relative">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-6 animate-fade-up">
              <span className="section-eyebrow mb-4 block">Premium Jain Heritage</span>
              ...
              <p className="text-lg text-brand-brown/70 max-w-lg mb-10 leading-relaxed">
                Experience the heritage of authentic Jain papads. Crafted with traditional recipes and modern quality standards.
              </p>
            ...
            <div className="lg:col-span-6 relative">
              <div className="relative aspect-[4/5] rounded-4xl overflow-hidden shadow-lift bg-brand-cream-dark">
              ...
              <div className="absolute -bottom-6 -left-6 bg-brand-yellow p-6 rounded-3xl shadow-card hidden sm:block">
      ...
      <section className="bg-white border-y border-brand-brown/5">
        <div className="container-max container-px py-10">
          <div className="flex flex-wrap justify-center gap-8 lg:gap-16">
            {[{ icon: Leaf, label: '100% Vegetarian' }, { icon: Shield, label: 'FSSAI Certified' }, { icon: Award, label: 'Traditional Recipe' }].map((item, i) => (
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-brand-cream/70 mb-8 leading-relaxed">
                From the Nimar region to your kitchen, Kawad Swad maintains the highest standards of Jain food purity. Our process respects traditional methods while ensuring hygienic, modern production.
              </p>
      ...
      <CTABanner
        ...
        description="Join thousands of happy customers who trust Kawad Swad for their daily papad needs."
