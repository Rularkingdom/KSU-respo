          ...
          <div className="max-w-2xl mx-auto">
            ...
            <Reveal delay={100}>
              <div className="card p-6 sm:p-8">
                {form.status === 'success' && (
                  <div className="mb-5">
                    <FormStatusMessage status="success" successMsg="Your enquiry has been received. We will contact you soon." />
                  </div>
                )}
                <form onSubmit={submit} noValidate>
                  <FormContainer>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      ...
                      <FormField label="Location" name="location" value={form.values.location} onChange={(v) => form.setValue('location', v)} error={form.errors.location} required />
                    </div>
                  ...
                  <div className="mt-6 flex flex-col sm:flex-row gap-3">
                    ...
                    <Link to="/business" className="btn-ghost">Back to Business Hub <ArrowRight className="w-4 h-4" /></Link>
                  </div>
                </form>
              </div>
            </Reveal>
